const dummyStore = [
  ...
  },
  {
    ...
    prepBend: `The 10" base rings get spun/bent on Mark's magic table motor. Use the jig that is marked for 1/4" to make 10" rings. Use the compressed air cutter to cut the rings. Don't forget ear protection.`,
    prepWeld: `Weld the 10" base rings. Mark all of the 9 1/8" base pieces in the center. Weld the 16: stems to the 9 1/8" base pieces. Marty has a steel square so you can make a proper right angle. Hold it an extra moment so it cools straight. Weld these T's into the rings, placing one weld on the ring connection weld. Eyeball it to make sure it stands up straight. Weld the center rings with 2 x 14" diameter MG pieces.`,
    weld: `Brace the welded base piece on the edge of the table so that the ring part hangs off and the stem lies flat. It can be helpful to mark a straight line across your table where the stem lies. This will help you keep your ball straight.Line up the MG ring at the top of the stem. Marty has a heavy metal chunk with a handle that you should place on the ring before welding. This will keep it from moving once heated. Weld MG ring to 16” stem. Weld perpendicular (90 degree angle) 14” diameter MG piece. Weld the in-between 2 x 14” diameter MG pieces (approx 45 degree angle). Add the 4 x 8” foot spikes. Two can go under where the crosspiece of the base meets the base ring. The other two halfway around. Flip the ball over so that the flat side of your MG faces up. Weld on the remaining 3 x 14” diameter MG pieces exactly as you did the first side. Backweld.
    `,
    comments: [
      {
        id: 1,

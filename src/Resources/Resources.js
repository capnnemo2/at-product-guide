  ...
  render() {
    return (
      <div className="Resources">
        ...
        <section>
          <div className="trellis-div">
            <h2>Trellises</h2>
            <p className="text-block">
              Trellis mesh measurements are provided with the height x width.
              When you cut the mesh, the width of the mesh is open on both
              sides, open on the top, but not the bottom.
            </p>
            <p className="text-block">
              Generally, hard 3/8" cross pieces are 1" narrower than the width
              of the trellis/mesh (IE: FT51 requires 2 x 11"), but depending on
              your mess cutting style you may have to adjust your measurements.
            </p>
            <p className="text-block">
            ...
            <ul className="trellis-feet">
              ...
              <li>
                EXCEPTION: CTs do not require additional foot spikes despite
                being 2' wide on each side. The cornered structure makes them
                plenty stable.
              </li>
            </ul>
          </div>
          <div className="arbor-div">
            <h2>Arbors</h2>
            <p className="text-block">
